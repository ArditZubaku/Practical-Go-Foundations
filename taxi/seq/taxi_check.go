...
they math the ones in the index file.
  ...
  - If there's a mismatch, print the offending file(s) and exit the program with
    ...
    INFO: Grab taxi-sha256.zip (https://storage.googleapis.com/353solutions/c/data/taxi-sha256.zip) from the web site and open it. The index file is sha256sum.txt
*/
package main
